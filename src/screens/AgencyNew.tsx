...
import { AgencyFormFields, type NewRule } from '../components/AgencyFormFields'
...
export function AgencyNew() {
  ...
  // Saving the extra rates is a second round-trip, so track pending state here
  ...
  return (
    <>
      ...
      <AgencyFormFields
        ...
        onSubmit={(values, extraRules: NewRule[]) => {
          setSaving(true)
